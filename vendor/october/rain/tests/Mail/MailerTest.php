...
class MailerTest extends TestCase
{
    ...
    public function testProcessRecipients()
    {
         ...
         * Object
         */
        $recipients = (object) ['mail' => 'user@domain.tld', 'name' => 'Adam Person'];
         ...
         */
        $recipients = [
            (object) ['mail' => 'person@one.tld', 'name' => 'First Person'],
            (object) ['mail' => 'person@two.tld', 'name' => 'Second Person'],
            (object) ['mail' => 'person@three.tld', 'address' => 'Some address somewhere', 'name' => 'Third Person']
        ];
        $result = self::callProtectedMethod($mailer, 'processRecipients', [$recipients]);
        $this->assertCount(3, $result);
         ...
         */
        $recipients = [
            ['mail' => 'person@one.tld', 'name' => 'First Person'],
            ['address' => 'person@two.tld', 'name' => 'Second Person'],
            ['mail' => 'person@three.tld', 'address' => 'XXX@two.tld', 'name' => 'Third Person']
        ];
        $result = self::callProtectedMethod($mailer, 'processRecipients', [$recipients]);
        $this->assertCount(3, $result);
        $this->assertArrayHasKey('person@one.tld', $result);

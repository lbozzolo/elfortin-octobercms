...
class Swift_Bug206Test extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->doTestHeaderIsFullyEncoded('mail@example.org', 'Family Name, Name', ' "Family Name, Name" <mail@example.org>');
        $this->doTestHeaderIsFullyEncoded('mail@example.org', 'Family Namé, Name', ' Family =?utf-8?Q?Nam=C3=A9=2C?= Name');
        $this->doTestHeaderIsFullyEncoded('mail@example.org', 'Family Namé , Name', ' Family =?utf-8?Q?Nam=C3=A9_=2C?= Name');
        $this->doTestHeaderIsFullyEncoded('mail@example.org', 'Family Namé ;Name', ' Family =?utf-8?Q?Nam=C3=A9_=3BName?= ');
    }

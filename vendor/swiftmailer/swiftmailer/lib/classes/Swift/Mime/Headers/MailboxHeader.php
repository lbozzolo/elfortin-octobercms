...
class Swift_Mime_Headers_MailboxHeader extends Swift_Mime_Headers_AbstractHeader
{
     ...
     * key=>value pairs where (mail => personalName).
     * Example:
     * <code>
     * <?php
    ...
    /**
     * Makes this Header represent a list of plain mail addresses with no names.
     *
     * Example:
     * <code>
     * <?php
     * //Sets three mail addresses as the Header data
     * $header->setAddresses(
    ...
    /**
     * Get all mail addresses in this Header.
     *
     * @see getNameAddresses()
     *
     * @return string[]

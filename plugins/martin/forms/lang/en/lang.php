    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_subject'      => ['title' => 'Subject'            , 'description' => 'Override default mail subject'],
                'mail_recipients'   => ['title' => 'Recipients'         , 'description' => 'Specify mail recipients (add one address per line)'],
                'mail_bcc'          => ['title' => 'BCC'                , 'description' => 'Send blind carbon copy to mail recipients (add one address per line)'],
                'mail_replyto'      => ['title' => 'ReplyTo Email Field', 'description' => 'Form field containing the mail address of sender to be used as "ReplyTo"'],
                ...
                'mail_resp_enabled' => ['title' => 'Send Auto-Response' , 'description' => 'Send an auto-response mail to the person submitting the form'],
                'mail_resp_field'   => ['title' => 'Email Field'        , 'description' => 'Form field containing the mail address of the recipient of auto-response'],
                'mail_resp_from'    => ['title' => 'Sender Address'     , 'description' => 'Email address of auto-response mail sender (e.g. noreply@yourcompany.com)'],
                'mail_resp_subject' => ['title' => 'Subject'            , 'description' => 'Override default mail subject'],

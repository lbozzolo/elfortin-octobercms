    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_enabled'      => ['title' => 'Enviar Notificações'          , 'description' => 'Enviar notificações por mail em todos os formulários enviados'],
                'mail_subject'      => ['title' => 'Assunto'                      , 'description' => 'Substitui o assunto de mail padrão'],
                'mail_recipients'   => ['title' => 'Destinatários'                , 'description' => 'Especifique destinatários de mail (adicione um endereço por linha)'],
                'mail_uploads'      => ['title' => 'Enviar Uploads'               , 'description' => 'Enviar uploads como anexos'],
                'mail_resp_enabled' => ['title' => 'Enviar Resposta Automática'   , 'description' => 'Enviar um mail de resposta automática para a pessoa que envia o formulário'],
                'mail_resp_field'   => ['title' => 'Campo de Email'               , 'description' => 'Campo de formulário que contém o endereço de mail do destinatário da resposta automática'],
                'mail_resp_from'    => ['title' => 'Endereço do Remetente'        , 'description' => 'Endereço de mail do remetente de e-mail de resposta automática (por exemplo, noreply@yourcompany.com)'],

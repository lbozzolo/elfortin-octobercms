    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'mail_subject'      => ['title' => '主题'            , 'description' => 'Override default mail subject'],
                'mail_recipients'   => ['title' => '收件人'         , 'description' => 'Specify mail recipients (add one address per line)'],
                'mail_bcc'          => ['title' => '密送'                , 'description' => 'Send blind carbon copy to mail recipients (add one address per line)'],
                'mail_replyto'      => ['title' => '回复邮件字段', 'description' => 'Form field containing the mail address of sender to be used as "ReplyTo"'],
                ...
                'mail_resp_enabled' => ['title' => '发送自动回复' , 'description' => 'Send an auto-response mail to the person submitting the form'],
                'mail_resp_field'   => ['title' => '邮件字段'        , 'description' => 'Form field containing the mail address of the recipient of auto-response'],
                'mail_resp_from'    => ['title' => '发件人地址'     , 'description' => 'Email address of auto-response mail sender (e.g. noreply@yourcompany.com)'],
                'mail_resp_subject' => ['title' => '主题'            , 'description' => 'Override default mail subject'],

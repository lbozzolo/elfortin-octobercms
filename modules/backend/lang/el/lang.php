...
return [
    ...
    'account' => [
        ...
        'enter_email' => 'Συμπληρώστε το mail σας',
    ...
    'user' => [
        ...
        'send_invite' => 'Αποστολή πρόσκλησης μέσω mail',
    ...
    'myaccount' => [
        ...
        'menu_description' => 'Ενημερώστε τις λεπτομερείς του λογαριασμού σας όπως το όνομα, την διεύθυνση mail και τον κωδικού.',

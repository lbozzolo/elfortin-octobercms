...
return [
    ...
    'mail' => [
        ...
        'menu_description' => 'Manage mail configuration.',
        'general' => 'General',
        'method' => 'Mail method',
    ...
    'mail_templates' => [
        ...
        'menu_description' => 'Modify the mail templates that are sent to users and administrators, manage mail layouts.',
        ...
        'test_confirm' => 'Send test message to :mail. Continue?',
    ...
    'mail_brand' => [
        ...
        'sample_template' => [
            ...
            'subcopy' => 'This is the subcopy of the mail',
            'thanks' => 'Thanks'
        ],
        'fields' => [

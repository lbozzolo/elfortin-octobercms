...
return [
    ...
    'mail_templates' => [
        ...
        'test_confirm' => 'Enviar uma mensagem de teste para :mail. Continuar?',
    ...
    'mail_brand' => [
        ...
        'menu_description' => 'Modifique as cores e a aparência dos modelos de mail.',
        'page_title' => 'Personalizar aparência de mail',
        'sample_template' => [
            'heading' => 'Título',
            ...
            'subcopy' => 'Esta é a subcópia do mail',
            'thanks' => 'Obrigado'
        ],
        'fields' => [
